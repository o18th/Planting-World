  ...
  <div class="container">
    ...
    <form action="{{ route('search') }}" method="get">
      <div class="input-group mb-3">
        <input type="text" class="form-control" id="search" name="search" placeholder="{{$search}}" aria-describedby="button-addon2">
    ...
    <div class="card-columns">
      @forelse ($plants as $plant)
        ...
        <div class="p-5 user-select-none" style="display:block">
    ...
    {{ $plants -> appends(['search'=>request()->search]) -> links('vendor.pagination.bootstrap-4') }}
